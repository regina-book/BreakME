...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT message, WPARAM wParam,
	...
	{
	case WM_CREATE:
		txtEdit = CreateWindowEx(0, TEXT("EDIT"), TEXT("Oberyn :'("),
				WS_CHILD | WS_VISIBLE, 25, 125, 200, 20, hwnd, NULL,
				hThisInstance, NULL);

		btnOk = CreateWindowEx(0, TEXT("BUTTON"), TEXT("Ok"),
				WS_CHILD | WS_VISIBLE, 230, 125, 40, 20, hwnd, NULL,
				hThisInstance, (LPVOID) NULL);

		lblRight = CreateWindowEx(0, TEXT("STATIC"),
				TEXT("Oh YEAH ! You are a PRINCE ! :D"), WS_CHILD, 80, 80, 120,
				40, hwnd, NULL, hThisInstance, NULL);

		lblWrong = CreateWindowEx(0, TEXT("STATIC"),
				TEXT("You wrong, any bottle of wine ?"), WS_CHILD, 220, 40, 120,
				40, hwnd, NULL, hThisInstance, NULL);
